...
function Agent(cfg) {
  ...
  this.lastResults = []; //current benman result. this value is cleared for each run
  this.lastAggregatedReusults = null; // current benman aggregated results. this value is cleared for each run.
  this.host = cfg.url;
  this.running = false;
